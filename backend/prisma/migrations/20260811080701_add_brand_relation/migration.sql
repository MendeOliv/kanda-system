...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CASH', 'APPYPAY');

-- CreateEnum
CREATE TYPE "Zone" AS ENUM ('KK5000', 'KILAMBA');
...
-- CreateIndex
CREATE UNIQUE INDEX "Payment_appypayTransactionId_key" ON "Payment"("appypayTransactionId");

-- CreateIndex
CREATE INDEX "Payment_appypayTransactionId_idx" ON "Payment"("appypayTransactionId");
...
-- CreateIndex
CREATE UNIQUE INDEX "OtpAttempt_phone_key" ON "OtpAttempt"("phone");
