  ...
  return (
    <main className="max-w-container-max mx-auto px-gutter py-lg">
      <nav className="flex items-center gap-xs font-label-md text-label-md text-outline mb-gutter">
        <Link href="/carrinho" className="hover:text-primary cursor-pointer transition-colors">{t("breadcrumb.cart")}</Link>
        <span className="material-symbols-outlined text-[16px]">chevron_right</span>
        <span className="text-primary font-bold">{t("breadcrumb.checkout")}</span>
      </nav>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-lg items-start">
        <div className="lg:col-span-8 flex flex-col gap-gutter">
          <section className="bg-surface-container-lowest p-md rounded-xl shadow-sm border border-surface-container">
            <div className="flex justify-between items-center mb-md">
              <div className="flex items-center gap-sm">
                ...
                <h2 className="font-headline-md text-headline-md text-on-surface">{t("address.title")}</h2>
              </div>
              <button type="button" className="text-primary font-label-md hover:underline">{t("address.addNew")}</button>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-sm">
              <div className="p-md rounded-lg border-2 border-primary bg-primary-container/5 cursor-pointer relative">
                ...
                <p className="font-label-md text-primary mb-1">{t("address.primary")}</p>
                <h3 className="font-bold text-on-surface">{t("address.home")}</h3>
              ...
              <div className="p-md rounded-lg border border-outline-variant hover:border-primary/50 transition-colors cursor-pointer">
                <p className="font-label-md text-on-surface-variant mb-1">{t("address.work")}</p>
          ...
          <section className="bg-surface-container-lowest p-md rounded-xl shadow-sm border border-surface-container">
            <div className="flex items-center gap-sm mb-md">
              ...
              <h2 className="font-headline-md text-headline-md text-on-surface">{t("payment.title")}</h2>
            </div>
            <div className="space-y-sm">
              {[
                { name: t("payment.multicaixa"), desc: t("payment.multicaixaDesc"), icon: "payments" },
                { name: t("payment.cash"), desc: t("payment.cashDesc"), icon: "point_of_sale" },
                { name: t("payment.transfer"), desc: t("payment.transferDesc"), icon: "account_balance" },
              ].map((method, i) => (
          ...
          <section className="bg-surface-container-lowest p-md rounded-xl shadow-sm border border-surface-container">
            <div className="flex items-center gap-sm mb-md">
              ...
              <h2 className="font-headline-md text-headline-md text-on-surface">{t("delivery.title")}</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-sm">
              <div className="p-md rounded-lg border-2 border-primary bg-primary-container/5 flex flex-col gap-xs">
                <div className="flex justify-between items-start">
                  <h3 className="font-bold text-on-surface">{t("delivery.standard")}</h3>
                  <p className="font-bold text-primary">1.500 Kz</p>
                </div>
                <p className="font-body-md text-on-surface-variant">{t("delivery.standardDesc")}</p>
                <div className="mt-2 flex items-center gap-xs text-primary font-label-md">
                  <span className="material-symbols-outlined text-[18px]">schedule</span>
                  <span>{t("delivery.estimated")}</span>
                </div>
              </div>
              <div className="p-md rounded-lg border border-outline-variant hover:border-primary/50 transition-colors flex flex-col gap-xs cursor-pointer">
                <div className="flex justify-between items-start">
                  <h3 className="font-bold text-on-surface">{t("delivery.express")}</h3>
                  <p className="font-bold text-on-surface-variant">3.000 Kz</p>
                </div>
                <p className="font-body-md text-on-surface-variant">{t("delivery.expressDesc")}</p>
                <div className="mt-2 flex items-center gap-xs text-on-surface-variant font-label-md">
                  <span className="material-symbols-outlined text-[18px]">bolt</span>
                  <span>{t("delivery.availableNow")}</span>
                </div>
              </div>
            </div>
          </section>
        ...
        <aside className="lg:col-span-4 sticky top-[100px] flex flex-col gap-md">
          <div className="bg-surface-container-lowest p-md rounded-xl shadow-md border border-surface-container">
            <h2 className="font-headline-md text-headline-md text-on-surface mb-md">{t("summary.title")}</h2>
            ...
            <div className="space-y-sm border-t border-surface-container pt-md">
              <div className="flex justify-between font-body-md text-on-surface-variant"><span>{t("review.subtotal")}</span><span>6.900 Kz</span></div>
              <div className="flex justify-between font-body-md text-on-surface-variant"><span>{t("review.deliveryFee")}</span><span>1.500 Kz</span></div>
              <div className="flex justify-between font-body-md text-on-surface-variant"><span>{t("summary.taxes")}</span><span>483 Kz</span></div>
            ...
            >
              {isSubmitting ? t("summary.processing") : t("summary.placeOrder")}
            </button>
          </div>
        </aside>
      </div>
